                ...
                <header>
                    <div id="kopf">  <!-- begin: kopf -->   
                        ...
                        <div id="titel">	 	
                            <h1>
                                <?php if (is_search()): ?>
                                    <?php printf(__('Search Results for: %s', '_rrze'), '<span>' . get_search_query() . '</span>'); ?>
                                <?php else: ?>         
                                    <?php the_title(); ?></h1> 
                            <?php endif; ?>
                        </div>       
                        ...
                        <?php if (_rrze_theme_options('searchform_position') == 'top'): ?>
                            <div id="suche">
                        ...
                        <div id="bereichsmenu">            
                            ...
                            <ul id="navigation"> 
                                <li class="first"><a class="aktiv"  href="/index.php">Startseite</a><span class="skip">. </span>
                                    ...
                                    <?php if (_rrze_theme_options('searchform_position') == 'bereichsmenu') : ?>
                                    <?php echo _rrze_search_form(); ?>
                                    <?php endif; ?>
                                </li>		
                            </ul>
